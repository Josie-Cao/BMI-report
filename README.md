...
analysis using root mean squared error (RMSE) with
respect to the actual movement trajectories. Among the
models tested, the kNN and Kalman filters performed the
best, achieving an RMSE of 15.51cm and runtime of 17.62
seconds.
